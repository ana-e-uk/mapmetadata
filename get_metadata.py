...
def main():
    ...
    metadata_df = pd.DataFrame(edge_metadata, columns=["u", "v", "k", "osmid", "inf_oneway", "osm_oneway", "inf_exp_speed", "inf_speed_limit", "osm_maxspeed", "inf_lanes", "osm_lanes", "osm_highway", "count", "min_s", "max_s", "q1", "q2", "q3"])
